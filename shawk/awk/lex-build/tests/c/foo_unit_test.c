...
static bool test_lex(void)
{
	...
	check(1 == foo_lex_get_input_line_pos(lex));
	check(1 == foo_lex_get_input_line_num(lex));
	...
	check('=' == foo_lex_get_curr_ch(lex));
	check(' ' == foo_lex_peek_ch(lex));
	check(4 == foo_lex_get_input_line_pos(lex));
	check(1 == foo_lex_get_input_line_num(lex));
	check(strcmp(foo_lex_tok_to_str(foo_lex_get_curr_tok(lex)), "<=") == 0);
	...
	check(8 == foo_lex_get_input_line_pos(lex));
	check(1 == foo_lex_get_input_line_num(lex));
	check(strcmp(foo_lex_tok_to_str(foo_lex_get_curr_tok(lex)), "==!") == 0);
	...
	check(' ' == foo_lex_peek_ch(lex));
	check(11 == foo_lex_get_input_line_pos(lex));
	check(1 == foo_lex_get_input_line_num(lex));
	...
	check('=' == foo_lex_peek_ch(lex));
	check(15 == foo_lex_get_input_line_pos(lex));
	check(1 == foo_lex_get_input_line_num(lex));
	...
	check(18 == foo_lex_get_input_line_pos(lex));
	check(1 == foo_lex_get_input_line_num(lex));
	check(strcmp(foo_lex_tok_to_str(foo_lex_get_curr_tok(lex)), "===") == 0);
	...
	check(' ' == foo_lex_peek_ch(lex));
	check(23 == foo_lex_get_input_line_pos(lex));
	check(1 == foo_lex_get_input_line_num(lex));
	...
	check(' ' == foo_lex_peek_ch(lex));
	check(12 == foo_lex_get_input_line_pos(lex));
	check(2 == foo_lex_get_input_line_num(lex));
	check(strcmp(foo_lex_tok_to_str(foo_lex_get_curr_tok(lex)), "id") == 0);
	check(foo_lex_match(lex, FOO_TOK_ID));
	...
	check('&' == foo_lex_get_curr_ch(lex));
	check('@' == foo_lex_peek_ch(lex));
	check(17 == foo_lex_get_input_line_pos(lex));
	check(2 == foo_lex_get_input_line_num(lex));
	check(strcmp(foo_lex_tok_to_str(foo_lex_get_curr_tok(lex)), "&") == 0);

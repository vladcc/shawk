...
const char * lex_usr_get_input(void * usr_arg, size_t * out_len);
// user events
...
// <lex_static_inline>
// read input
static inline void lex_get_input(lex_state * lex)
{
	size_t len = 0;
	lex->input = lex_usr_get_input(lex->usr_arg, &len);
...
static inline void lex_back_pos(lex_state * lex)
{
...
static inline int lex_peek_ch_n(lex_state * lex, int n)
{

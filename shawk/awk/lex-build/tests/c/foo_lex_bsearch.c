...
FOO_CH_CLS_GRTR_THAN,FOO_CH_CLS_NEW_LINE,FOO_CH_CLS_EOI,     FOO_CH_CLS_SLASH,   
FOO_CH_CLS_AUTO_1_, FOO_CH_CLS_AUTO_2_, 
};
...
foo_tok_id foo_lex_keyword_or_base(foo_lex_state * lex, foo_tok_id base)
{
	...
	byte first = (byte)*txt;
	uint vlens = kwlen[first].valid_lengths;

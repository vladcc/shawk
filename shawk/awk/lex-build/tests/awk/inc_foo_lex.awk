...
function foo_lex_read_line(    _ln) {
	...
	_B_foo_lex_line_pos = length(_B_foo_lex_line_str)+1
}
...
function foo_lex_get_line_num()
{return _B_foo_lex_line_num}
...
function foo_lex_state_get() {
	...
	_B_foo_lex_line_num          _FOO_LEX_SEP() \

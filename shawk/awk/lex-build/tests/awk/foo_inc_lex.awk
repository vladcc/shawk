...
function FOO_TOK_ERROR() {return "I am Error"}

function FOO_CH_CLS_SPACE() {return 1}
function FOO_CH_CLS_WORD() {return 2}
function FOO_CH_CLS_NUMBER() {return 3}
function FOO_CH_CLS_LESS_THAN() {return 4}
...
function foo_lex_read_ch() {
	...
	if (_B_foo_lex_peek_ch != "")
		...
		split(foo_lex_usr_get_line(), _B_foo_lex_input_line, "")
	return _B_foo_lex_curr_ch
}
...
function foo_lex_init() {
	...
	_B_foo_lex_curr_tok = "I am Error"
...
function foo_lex_next() {
	...
	while (1) {
		...
		if (1 == _B_foo_lex_curr_ch_cls_cache) { # FOO_CH_CLS_SPACE()
			continue
		} else if (2 == _B_foo_lex_curr_ch_cls_cache) { # FOO_CH_CLS_WORD()
			_B_foo_lex_curr_tok = foo_lex_usr_get_word()
		} else if (3 == _B_foo_lex_curr_ch_cls_cache) { # FOO_CH_CLS_NUMBER()
			_B_foo_lex_curr_tok = foo_lex_usr_get_number()
		} else if (4 == _B_foo_lex_curr_ch_cls_cache) { # FOO_CH_CLS_LESS_THAN()
			_B_foo_lex_curr_tok = "<"
			if ("=" == foo_lex_peek_ch()) {
				foo_lex_read_ch()
				_B_foo_lex_curr_tok = "<="
			} 
		} else if (5 == _B_foo_lex_curr_ch_cls_cache) { # FOO_CH_CLS_GRTR_THAN()
			_B_foo_lex_curr_tok = ">"
			if ("=" == foo_lex_peek_ch()) {
				foo_lex_read_ch()
				_B_foo_lex_curr_tok = ">="
			} 
		} else if (6 == _B_foo_lex_curr_ch_cls_cache) { # FOO_CH_CLS_NEW_LINE()
			++_B_foo_lex_line_no
			_B_foo_lex_line_pos = 1
			continue

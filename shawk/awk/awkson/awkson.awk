...
# <parse>
#
# translated by rdpg-to-awk.awk 2.2.1
# generated by rdpg-comp.awk 2.2.5
# 
# Synchronization (Sync): 0
# Immediate error detection (Imm): 1
# 
# Grammar:
# 
...
function _lex_read_line(    _ln) {
	...
	_B__lex_line_pos = length(_B__lex_line_str)+1
	return 0
}
...
function _lex_get_line_num()
{return _B__lex_line_num}
...
# <lex_state>
function _lex_state_get() {
	return \
	( \
	_B__lex_line_str          __LEX_SEP() \
	_B__lex_curr_ch           __LEX_SEP() \
	_B__lex_curr_ch_cls_cache __LEX_SEP() \
	_B__lex_curr_tok          __LEX_SEP() \
	_B__lex_line_num          __LEX_SEP() \
	_B__lex_line_pos          __LEX_SEP() \
	_B__lex_peek_ch           __LEX_SEP() \
	_B__lex_peeked_ch_cache   __LEX_SEP() \
	_B__lex_saved             __LEX_SEP() \
	)
}

function _lex_state_set(state_str,    _arr_st) {
	split(state_str, _arr_st, __LEX_SEP())

	_B__lex_line_str          = _arr_st[1]
	split(_B__lex_line_str, _B__lex_input_line, "")
	_B__lex_curr_ch           = _arr_st[2]
	_B__lex_curr_ch_cls_cache = _arr_st[3]
	_B__lex_curr_tok          = _arr_st[4]
	_B__lex_line_num          = _arr_st[5]
	_B__lex_line_pos          = _arr_st[6]
	_B__lex_peek_ch           = _arr_st[7]
	_B__lex_peeked_ch_cache   = _arr_st[8]
	_B__lex_saved             = _arr_st[9]
}
# </lex_state>
...
print "<awklib_prog>"
print "Library: prog"
print "Description: Provides program name, error, and exit handling."
print "Version 1.0"
print ""
